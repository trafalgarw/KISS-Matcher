...
int main() {
  ...
  calcErrors(T,
             solution_by_quatro.rotation,
             solution_by_quatro.translation,
             rot_error_quatro,
             ts_error_quatro);
  // Compare results
  ...
  calcErrors(T,
             solution_by_teaser.rotation,
             solution_by_teaser.translation,
             rot_error_teaser,
             ts_error_teaser);
  // Compare results
  ...
  // If you want to save it, please use below line
