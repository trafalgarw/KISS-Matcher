#ifndef CPP_EXAMPLES_INCLUDE_QUATRO_QUATRO_UTILS_H_
#define CPP_EXAMPLES_INCLUDE_QUATRO_QUATRO_UTILS_H_
...
inline Eigen::Matrix3d get3DRot(const double yaw_deg,
...
void calcErrors(const Eigen::Matrix4d &T,
                const Eigen::Matrix3d est_rot,
                const Eigen::Vector3d est_ts,
                double &rot_error,
                double &ts_error) {
...
void getParams(const double noise_bound,
...
#endif  // CPP_EXAMPLES_INCLUDE_QUATRO_QUATRO_UTILS_H_
